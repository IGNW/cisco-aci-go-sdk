...
func (ss SubjectService) New(name string, description string) *Subject {
...
func (ss SubjectService) Save(s *Subject) error {
...
func (ss SubjectService) Get(domainName string) (*Subject, error) {
...
func (ss SubjectService) GetAll() ([]*Subject, error) {
	var epgs []*Subject
	var errors error
...
func (ss SubjectService) fromJSON(data *gabs.Container) (*Subject, error) {
	var errors error
