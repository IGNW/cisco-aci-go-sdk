...
func (vs VRFService) New(name string, description string) *VRF {
...
func (vs VRFService) Save(v *VRF) error {
...
func (vs VRFService) Get(domainName string) (*VRF, error) {
...
func (vs VRFService) GetAll() ([]*VRF, error) {
	var vrfs []*VRF
	var errors error
...
func (vs VRFService) fromJSON(data *gabs.Container) (*VRF, error) {
	var errors error
